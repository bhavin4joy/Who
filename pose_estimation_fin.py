...
def get_paf_and_heatmap(model, img_raw, scale_search, param_stride=8, box_size=368):
    ...
    heatmap_avg = torch.zeros(len(multiplier), 19, img_raw.shape[0], img_raw.shape[1])                                                     
    ...
    for i, scale in enumerate(multiplier):
        ...
        paf = nn.UpsamplingBilinear2d((img_raw.shape[0], img_raw.shape[1]))(output1)
